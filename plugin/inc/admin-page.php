	...
	update_option(
		...
		nerv_core_cover_sanitize_options(
			array(
				...
				'fallback_routes' => (array) ( $params['imageFeature']['fallback_routes'] ?? $params['imageFeature']['fallbackRoutes'] ?? array() ),
...
function nerv_core_control_ai_services_form_data( array $cover_options, array $cover_status ): array {
	...
	return array(
		...
		'textFeature'    => array(
			...
			'fallback_routes' => function_exists( 'nerv_core_ai_sanitize_fallback_routes' ) ? nerv_core_ai_sanitize_fallback_routes( $text_feature['fallback_routes'] ?? $text_feature['fallbackRoutes'] ?? array() ) : array(),
		),
		'imageFeature'   => array(
			...
			'fallback_routes' => function_exists( 'nerv_core_ai_sanitize_fallback_routes' ) ? nerv_core_ai_sanitize_fallback_routes( $image_feature['fallback_routes'] ?? $image_feature['fallbackRoutes'] ?? ( $cover_options['fallback_routes'] ?? array() ) ) : array(),
		),
