...
add_check( $checks, 'slug batch runtime lock', str_contains( (string) file_get_contents( $root . '/plugin/inc/geo-slug-batch.php' ), 'nerv_core_geo_slug_acquire_lock' ) && str_contains( (string) file_get_contents( $root . '/plugin/inc/geo-slug-batch.php' ), '已有 GEO slug 批次运行中' ), 'GEO slug batch has a runtime lock to prevent overlapping cron/manual batches.' );
